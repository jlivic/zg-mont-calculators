...
public class F10112cet extends Composite {
	 ...
	 * @param style
	 */
	public F10112cet(final Composite parent, int style) {
		super(parent, style);
		setBounds(1000, 600, 360, 900);
		...
		combo.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent arg0) {
				...
				txtCE.setText(ElementsDao.calculate1011_2_cet(selectedElement));
			}
